...
{
    public class ImageListCarouselView_PublicViewComponent : ViewComponent
    {
        private readonly PH_SwagEntity db;
        private readonly IConfiguration iconfig;

        public ImageListCarouselView_PublicViewComponent(PH_SwagEntity db, IConfiguration iconfig)
        {
            this.db = db;
